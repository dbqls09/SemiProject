...
<div class="custo-main">
   <div class="main-block">
      ...
      <div class="block-content">
         <a href="<%=request.getContextPath() %>/qna/write" title="1:1 문의 페이지로 이동">
            <p>
               <strong style="color:white;">1:1 문의</strong>
      ...
      <div class="block-content">
         <a href="<%=request.getContextPath() %>/notice/list" title="공지사항 페이지로 이동">
            <p>
               <strong style="color:white;">공지사항</strong>
               공지사항을 확인해주세요 
            </p>
         </a>
      </div>
   ...
   <div class="image">
   <img src="https://img.megabox.co.kr/SharedImg/event/2022/10/06/0EU4wP5csR6YKknItCgqh2VcCiByFBwA.jpg" alt="">
   <div class="cont">
