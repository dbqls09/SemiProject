...
<table class="table table-boarderd">
	<tr>
  	<td class="success" >글번호</td><td><%= updateQna.getQna_no() %></td>
  	<td class="success">아이디</td><td><%=updateQna.getQna_userid() %></td>
  	<td class="success">작성일</td><td><%= updateQna.getQna_date() %></td> 
	</tr>
		
	<tr>	
  	<td class="success" colspan="1">제목</td><td colspan="5" ><input type="text" name="qna_title" style="width:100%;" value="<%=updateQna.getQna_title() %>"></td> 
	</tr>	
	...
	<td class="success" colspan="6">내용</td>
  	...
  	<tr><td colspan="6"><textarea id="content" name="qna_content"  style="width:100%; height: 500px;">
